...
<form action="opd_view_all.php" method="POST">
...
$campf = $_POST['campf'];
$sql = "SELECT * FROM `opd` WHERE camp=$campf";
...
echo " <table border='2px'>
        	<tr><th colspan='13'>Patients Medicine Dispensing Record</th></tr>
        	<th>Pat ID</th><th>Patient Name</th><th>Patient age</th><th>Medication 1</th><th>QTY</th><th>Medication 2</th><th>QTY</th><th>Medication 3</th><th>QTY</th><th>Medication 4</th><th>QTY</th><th>Date&Time</th></tr>";
...
echo "<b><font color=red size='5pt'>Total OPD Patients: $rowcount</font></b>";
