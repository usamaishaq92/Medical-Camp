...
<table border="10" align="center">
  <tr>
    <td align="center"><font color="green"><b>Result Entry Edit</b></font></td>
  </tr>
  <tr>
  <td>
  <table>
  <form action="lab_edit.php" method="POST">
...
<table>
    ...
    <form action="lab_edit_link.php" method="POST">
   <td>Patient ID</td>
	...
	<tr>
      ...
      <td><input type="text" name="glu" value="<?php echo $glu;?> " size="20">
      </td>
	  </tr>
	<tr>
	  <td>HEP B SURFACE ANTIGEN (ICT)</td>
      <td><select name="hepb"><option value="<?php echo $hepbe;?> "><?php echo $hepbe;?></option>
	...
	<tr>
      ...
      <td><select name="hepc"><option value="<?php echo $hepce;?> "><?php echo $hepce;?></option>
                  <option value="Negative">Negative</option>
                  <option value="Positive">Positive</option>
      </select>
    </tr>
    ...
    <tr>
	  ...
	  <td>
<input type="button" onclick="location.href='lab_edit.php';" value="Refresh" />	  
	  </td>
	  <td>
<input type="button" onclick="location.href='lab.php';" value="Back" />	  
	  </td>
    </tr>
    </table>
  </td>
