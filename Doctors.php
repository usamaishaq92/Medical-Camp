...
<table border="10" align="center">
  <tr>
    <td align="center"><font color="green"><b>Patient Medical Record</b></font></td>
  </tr>
  <tr>
  <td>
  <table>
...
<table>
   ...
   <td>Patient ID</td>
	...
	<tr>
	  ...
	  <td>CAT</td>
      <td><input type="text" name="inv" value="ADULT" size="3" readonly>
      </td>
	 
	  <tr>
	  <td><center><font color="red"><b>*Investigations Results</B></font></center></td>
	  </tr>
	  <tr>
      <td>GLUCOMETER BLOOD SUGAR</td>
      <td><input type="text" name="glu" value="<?php echo $glu;?> " size="5" readonly>
      </td>
	  </tr>
	<tr>
	  <td>HEP B SURFACE ANTIGEN (ICT)</td>
      <td><input type="text" name="hepb" value="<?php echo $hepb;?> " size="10" readonly>
      </td>
    </tr>
	<tr>
	  <td>HEPATITS C VIRUS (ICT)</td>
      <td><input type="text" name="hepc" value="<?php echo $hepc;?> " size="10" readonly>
      </td>
    </tr>
...
echo "<option value='".$row['med']."'>".$row['med']."</option>";}?>	
    ...
    <tr>
	  ...
	  <td>
<input type="button" onclick="location.href='Doctors.php';" value="Refresh" />	  
	  </td>
    </tr>
    </table>
  </td>
...
<tr>
  <th colspan="2"><a href="baby.php">P.M.R For Babies</a></th>
</tr>
<tr>
